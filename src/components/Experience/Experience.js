...
function Experience(props) {
  return (
    ...
    <WorkCard image={coda} extlink="https://coda.io/@bianca/reflections-on-my-internship-at-coda" title="Minds" description="Software Engineer Intern, Kleiner Perkins Fellow"/>
    <WorkCard image={dailycal} extlink="https://www.dailycal.org/author/biancalee/" title="Sidetrek" description={`Opinion Columnist of "Head in the Cloud"`}/>
    <WorkCard image={fb} link="/fb" title="Samsung Electronics" description="Software Engineer Intern"/>
